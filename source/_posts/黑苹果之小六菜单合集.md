...
- 备用链接：https://shoaling.lanzous.com/iDwUwmaqafi
...
- 文件仓库：https://share.olaindex.com/t/WJ60ddj6om
  
- 备用链接；https://cloud.189.cn/t/nM7RR3A3ENzu
...
### 26-EFI分享
- 通用efi下载：https://download.shaoxingshare.com/t/9jkMKzv21y
  - 台式机：查询CPU架构，所得英文名对应的zip包即你可用的。
  - 笔记本：查询CPU架构，所得几代架构，选择对应的即可。
  - **通用整合包：使用方式同上，但是需要选择并改名对应config文件！！！**
- 备用链接：https://shoaling.lanzous.com/b01u0pjpg 密码:3d5p
...
- 教程里涉及到的链接：
 ...
 2. 启动盘制作工具balenaEtcher下载：https://download.shaoxingshare.com/t/Kn0vg9dz47
...
### 28-镜像下载
**微信首发**：
macOS Big Sur 11.2.3 20D91 原版镜像：https://blog.daliansky.net/macOS-BigSur-11.2.3-20D91-Release-version-with-OC-0.6.7-and-Clover-5131-and-PE-original-image.html
- 温馨提醒：
...
**核显卡仿冒id查询(部落阁」：https://blog.daliansky.net/Intel-core-display-platformID-finishing.html**

**显卡HEVC硬解加速激活。删除显卡设备信息中AAPL,slot-name参数**
**HD4400-HD4600专用显卡参数**：https://download.shaoxingshare.com/t/ZAyMbqvbRx
...
2. 黑苹果万能声卡驱动「VoodooHDA.kext」
https://download.shaoxingshare.com/t/VaEvVeBGzl
...
- UDB定制脚本（WIN版）： https://github.com/USBToolBox/tool
  - 适用于直装最新版的小伙伴！！！
...
OC引导添加开机声音与图形界面：http://imacos.top/2020/06/19/1049/
...
- 复刻群文件：https://download.shaoxingshare.com/t/D15MPJBgkp
  - 线上的群文件更新途径
...
## 仓库
### 镜像仓库
- 主线:https://download.shaoxingshare.com/t/l0mvW0M1gx
- 备用:https://download.shaoxingshare.com/t/6GpM2WdLWR

### EFI
- 通用efi：https://download.shaoxingshare.com/t/9jkMKzv21y
  - 台式机通用-根据架构英文选择EFI文件
  - 笔记本通用-根据架构代数选择EFI文件
...
### 驱动仓库
驱动分流：https://download.shaoxingshare.com/t/opEvD3BRkW
 - 自我维护，更新可能不及时，勿催，

### 软件仓库
- 软件共享：https://download.shaoxingshare.com/t/qLEMqWB4lA
- balenaEtcher：https://download.shaoxingshare.com/t/Kn0vg9dz47

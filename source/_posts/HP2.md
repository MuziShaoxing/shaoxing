...
| Ventura<br/>13.0 | Monterey<br/>12.0 | Big Sur<br/>11.0 | Catalina<br/>10.15 | Mojave<br/>10.14 | High Sierra<br/>10.13 |
| ---------------- | ----------------- | ---------------- | ------------------ | ---------------- | --------------------- |
| 是               | 是                | 是               | 否                 | 否               | 否                    |
...
- 本次更新无任何内容
- 增加一条注释
  - Misc-Security-SecureBootModel设置成以下选项：
  - Disabled：可以重装系统
  - Default：可以在线升级 
...
- 再一次偶然的机会，我发现了之前版本无法用于安装，此包对此进行修复，你可以放心大胆的安装重置了。。。
...
- OpenCorePkg版本递增0.8.2「开发版」
- 恢复勾选怪癖“**AvoidRuntimeDefrag**”
- 取消引导参数“ **-lilubetaall**  ”
